...
const user = () => ({ fname: "Devendra", active: true }); // This will not return an object, it will return undefined because of the way arrow functions handle object literals
